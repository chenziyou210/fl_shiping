...
class UserRankLogic extends RankPageBaseLogic<_UserRankLogic> {
  UserRankLogic(this.type);
  @override
  _UserRankLogic state = _UserRankLogic();
  ...
  Future _loadData(int page, int type, void Function(List<RankNewEntity>) success){
    return HttpChannel.channel.userGiftRank(page: page, type: type)

 ...
 *  FileName: eliminate_font_animation_tabbar
 *  Author: Tonight丶相拥
 *  Date: 2021/7/19
 *  Description: 
 **/
...
class _TabStyle extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final Color color = selected
        ? selectedColor // Color.lerp(selectedColor, unselectedColor, animation.value)!
        : unselectedColor; //Color.lerp(unselectedColor, selectedColor, animation.value)!;
...
class EliminateFontAnimationTabBar extends StatefulWidget implements PreferredSizeWidget {
  ...
  const EliminateFontAnimationTabBar({
    Key? key,
    required this.tabs,
    this.controller,
...
class _TabBarState extends State<EliminateFontAnimationTabBar> {
  ...
  @override
  void didUpdateWidget(EliminateFontAnimationTabBar oldWidget) {
